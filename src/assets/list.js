export const list = [
    ...
    {
        en:"He rarely rides public transport",
        ru:"Он редко ездит на общественном транспорте",
    },
    {
        en:"My dog only eats special food",
    ...
    {
        en:"That movie was really boring",
        ru:"Тот фильм был очень скучным",
    },
    {
        en:"I’ll come by tomorrow morning",
    ...
    },
    {
        ...
        ru:"Эта зима будет холодной",
    },
    {
        en:"This is gonna be the hardest time of the semester",
        ru:"Это будет самый сложный зачет за семестр",
    },
    {
        en:"I’m not going with you tomorrow",
        ru:"Я не поеду с вами завтра",
    },
    {
